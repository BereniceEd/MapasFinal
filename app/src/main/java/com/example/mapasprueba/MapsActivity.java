...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng origen = new LatLng(20.081432,-101.128481);
        LatLng destino = new LatLng(20.083913,-101.127427);
    ...
    private String obtenerDireccionesURL(LatLng origin,LatLng dest){
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/"+output+"?"+parameters+"&key=AIzaSyC69im735dRrG4LtHyxduqr6bifbDSPOBY";
Log.e("laurl", url);
        return url;
    }
